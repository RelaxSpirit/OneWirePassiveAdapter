namespace DigitalThermometer.OneWire
{
    internal static class Crc8Helper
    {
        ...
        internal static byte CalculateCrc8(this byte[] array)
        {
            if (array is null) throw new ArgumentNullException(nameof(array));

            return CalculateCrc8(array, 0, array.Length - 1);
        }
        ...
        /// <returns>Value of CRC8 checksum</returns>
        internal static byte CalculateCrc8(this byte[] array, int startIndex, int endIndex)
        {
            if (array is null) throw new ArgumentNullException(nameof(array));
